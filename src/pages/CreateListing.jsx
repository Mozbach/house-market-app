    ...
    if(loading) {
     ...
     const onMutate = (e) => {
        ...
        if(!e.target.files) {
            setFormData((prevState) => ({
                ...prevState,
                [e.target.id]: boolean ?? e.target.value // if value on the left is a boolean, use that, else use the value on the right
            }))
        }
    ...
    <div className="profile">
        ...
        <main>
            ...
            <div className = "formRooms flex">
                ...
                <p className="imagesInfo">The first image will the the cover. Maximum of 6 Images.</p>            
                <input  
